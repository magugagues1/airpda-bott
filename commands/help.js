...
const CATEGORIAS = [
  ...
  },
  {
    ...
    emoji: '🌿',
    label: 'Drogas',
    descripcion: 'Cultivo y tráfico de sustancias',
    color: 0x16a34a,
    comandos: [
      { cmd: '/drogas info',          desc: 'Ver tipos de drogas y su rentabilidad' },
      { cmd: '!plantar [tipo]',       desc: 'Plantar en tu zona (marihuana/cocaína/meta/heroína)' },
      { cmd: '!plantaciones',         desc: 'Ver el estado de tus plantaciones activas' },
      { cmd: '!cosechar',             desc: 'Cosechar la plantación cuando esté lista' },
      { cmd: '!venderdroga [tipo]',   desc: 'Vender la cosecha en el mercado negro' },
      { cmd: '!efectos',              desc: 'Ver efectos activos de sustancias en ti' },
    ],
  },
  {
    id: 'bandas',
