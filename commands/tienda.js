...
const CATALOGO = {
  ...
  armamento: {
    ...
    items: [
      ...
      { id: 'pistola_fogueo', nombre: 'Pistola de fogueo', precio: 2000, emoji: '🔫', tipo: 'arma', equipable: true, desc: 'Solo RP' },
      { id: 'spray_defensa', nombre: 'Spray defensa',      precio:  350, emoji: '🛡️', tipo: 'arma', equipable: true, desc: 'Aerosol de defensa' },
      { id: 'pistola',       nombre: 'Pistola (9mm)',       precio: 5000, emoji: '🔫', tipo: 'arma', equipable: true, desc: 'Arma corta estándar' },
      { id: 'pistola50',     nombre: 'Pistola .50',         precio: 8000, emoji: '🔫', tipo: 'arma', equipable: true, desc: 'Alto calibre' },
      { id: 'smg',           nombre: 'Subfusil SMG',        precio: 12000, emoji: '🪖', tipo: 'arma', equipable: true, desc: 'Automática' },
      { id: 'rifle',         nombre: 'Rifle de asalto',     precio: 18000, emoji: '🪖', tipo: 'arma', equipable: true, desc: 'Rifle automático' },
      { id: 'escopeta',      nombre: 'Escopeta',            precio: 10000, emoji: '🔫', tipo: 'arma', equipable: true, desc: 'Disparo múltiple' },
      { id: 'sniper',        nombre: 'Rifle de precisión',  precio: 25000, emoji: '🔫', tipo: 'arma', equipable: true, desc: 'Largo alcance' },
      { id: 'muni_9mm',      nombre: 'Munición 9mm',        precio:  200, emoji: '🔴', tipo: 'municion', desc: 'Caja 50 balas' },
      { id: 'muni_45',       nombre: 'Munición .45',        precio:  250, emoji: '🔴', tipo: 'municion', desc: 'Caja 50 balas' },
      { id: 'muni_rifle',    nombre: 'Munición rifle',      precio:  350, emoji: '🔴', tipo: 'municion', desc: 'Caja 30 balas' },
      { id: 'muni_escopeta', nombre: 'Munición escopeta',   precio:  300, emoji: '🔴', tipo: 'municion', desc: 'Caja 25 cartuchos' },
      { id: 'silenciador',   nombre: 'Silenciador',         precio: 3000, emoji: '🔇', tipo: 'arma_mod', desc: 'Reduce ruido' },
      { id: 'mira_holo',     nombre: 'Mira holográfica',    precio: 2000, emoji: '🎯', tipo: 'arma_mod', desc: 'Precisión +10%' },
    ],
  },
  ...
  ilegal: {
    ...
    items: [
      { id: 'semilla_marihuana', nombre: 'Semillas de Marihuana',      precio: 500,  emoji: '🌱', tipo: 'semilla', nivelBanda: 1, cultivo: 'marihuana', desc: 'Planta marihuana (30min)' },
      { id: 'semilla_lsd',       nombre: 'Semillas de LSD',            precio: 800,  emoji: '🌱', tipo: 'semilla', nivelBanda: 1, cultivo: 'lsd',       desc: 'Planta LSD (45min)' },
      { id: 'semilla_cocaina',   nombre: 'Semillas de Cocaína',        precio: 1500, emoji: '🌱', tipo: 'semilla', nivelBanda: 2, cultivo: 'cocaina',   desc: 'Planta cocaína (60min)' },
      { id: 'semilla_extasis',   nombre: 'Semillas de Éxtasis',        precio: 2000, emoji: '🌱', tipo: 'semilla', nivelBanda: 2, cultivo: 'extasis',   desc: 'Planta éxtasis (90min)' },
      { id: 'semilla_meta',      nombre: 'Semillas de Metanfetamina',  precio: 3500, emoji: '🌱', tipo: 'semilla', nivelBanda: 3, cultivo: 'metanfetamina', desc: 'Planta metanfetamina (2h)' },
      { id: 'semilla_ketamina',  nombre: 'Semillas de Ketamina',       precio: 5000, emoji: '🌱', tipo: 'semilla', nivelBanda: 3, cultivo: 'ketamina',  desc: 'Planta ketamina (3h)' },
      { id: 'semilla_heroina',   nombre: 'Semillas de Heroína',        precio: 8000, emoji: '🌱', tipo: 'semilla', nivelBanda: 4, cultivo: 'heroina',   desc: 'Planta heroína (4h)' },
      { id: 'semilla_fentanilo', nombre: 'Semillas de Fentanilo',      precio: 12000, emoji: '🌱', tipo: 'semilla', nivelBanda: 5, cultivo: 'fentanilo', desc: 'Planta fentanilo (6h)' },
      ...
      { id: 'pistola_ilegal', nombre: 'Pistola sin serie',   precio: 8000, emoji: '🔫', tipo: 'arma', equipable: true, nivelBanda: 4, desc: 'Ilegal · Sin registro' },
